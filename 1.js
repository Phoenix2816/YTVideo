const API_KEY = "AIzaSyCvrrgfsUSzg2sZBeupvKbARwouxDb4ZME";
...
const preload = {
    ...
    text: '<p class = "preloader__text">загрузка...</p>',
    append() {
...
const convertISOToReadbleDuration = (isoduration) => {
    let hoursMatch = isoduration.match(/(\d+)H/)
    let minutesMatch = isoduration.match(/(\d+)M/)
    let secondsMatch = isoduration.match(/(\d+)S/)
...
const createListVideo = (videos, titleText, pagination) => {
        ...
        <article class="video-card">
            <a href="#/video/${video.id.videoId || video.id}" class="video-card__link">
                ...
                }" alt="Превью видео ${video.snippet.title}" class="video-card__thumbnail">

                <h3 class="video-card__title"></h3>${video.snippet.title}</h3>
            ...
            data-video-id="${video.id.videoId || video.id}">
                ...
                <path class="star-o" d="M11.4416 2.92501L12.9083 5.85835C13.1083 6.26668 13.6416 6.65835 14.0916 6.73335L16.7499 7.17501C18.4499 7.45835 18.8499 8.69168 17.6249 9.90835L15.5583 11.975C15.2083 12.325 15.0166 13 15.1249 13.4833L15.7166 16.0417C16.1833 18.0667 15.1083 18.85 13.3166 17.7917L10.8249 16.3167C10.3749 16.05 9.63326 16.05 9.17492 16.3167L6.68326 17.7917C4.89992 18.85 3.81659 18.0583 4.28326 16.0417L4.87492 13.4833C4.98326 13 4.79159 12.325 4.44159 11.975L2.37492 9.90835C1.15826 8.69168 1.54992 7.45835 3.24992 7.17501L5.90826 6.73335C6.34992 6.65835 6.88326 6.26668 7.08326 5.85835L8.54992 2.92501C9.34992 1.33335 10.6499 1.33335 11.4416 2.92501Z" fill="white" stroke="#151515" stroke-linecap="round" stroke-linejoin="round"/>
                <path class="star" d="M10.4417 1.925L11.9083 4.85833C12.1083 5.26666 12.6417 5.65833 13.0917 5.73333L15.75 6.175C17.45 6.45833 17.85 7.69166 16.625 8.90833L14.5583 10.975C14.2083 11.325 14.0167 12 14.125 12.4833L14.7167 15.0417C15.1833 17.0667 14.1083 17.85 12.3167 16.7917L9.82499 15.3167C9.37499 15.05 8.63332 15.05 8.17499 15.3167L5.68332 16.7917C3.89999 17.85 2.81665 17.0583 3.28332 15.0417L3.87499 12.4833C3.98332 12 3.79165 11.325 3.44165 10.975L1.37499 8.90833C0.158319 7.69166 0.549985 6.45833 2.24999 6.175L4.90832 5.73333C5.34999 5.65833 5.88332 5.26666 6.08332 4.85833L7.54999 1.925C8.34999 0.33333 9.64998 0.33333 10.4417 1.925Z" fill="#FB6231" stroke="#151515" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    videoSection.innerHTML = `
        <div class="container">
            <div class="video__player">
                <iframe class="video__iframe" src="https://www.youtube.com/embed/${video.id}" frameborder="0" allowfullscreen allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
            ...
            <div class="hero__container">
                <a class="hero__link" href="#/favorite">
                    ...
                    <svg class="hero__icon">
                            <path d="M10.4417 1.92495L11.9084 4.85828C12.1084 5.26662 12.6417 5.65828 13.0917 5.73328L15.75 6.17495C17.45 6.45828 17.85 7.69162 16.625 8.90828L14.5584 10.975C14.2084 11.325 14.0167 12 14.125 12.4833L14.7167 15.0416C15.1834 17.0666 14.1084 17.85 12.3167 16.7916L9.82505 15.3166C9.37505 15.05 8.63338 15.05 8.17505 15.3166L5.68338 16.7916C3.90005 17.85 2.81671 17.0583 3.28338 15.0416L3.87505 12.4833C3.98338 12 3.79171 11.325 3.44171 10.975L1.37505 8.90828C0.15838 7.69162 0.550046 6.45828 2.25005 6.17495L4.90838 5.73328C5.35005 5.65828 5.88338 5.26662 6.08338 4.85828L7.55005 1.92495C8.35005 0.333284 9.65005 0.333284 10.4417 1.92495Z" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
    
                    </svg>
                </a>

                <svg class="hero__logo" viewbox="0 0 360 48" role="img" aria-label="logotip of service You-Yvideo">
...
const createSearch = () => {
    ...
    form.innerHTML = `
    <input type="search" class="search__input" name = "search" placeholder="Найти видео..." required>
    <button class="search__btn" type="submit">
        <span>поиск</span>
        <svg class="search__icon">
        <path d="M9.66671 16C13.1645 16 16 13.1644 16 9.66665C16 6.16884 13.1645 3.33331 9.66671 3.33331C6.1689 3.33331 3.33337 6.16884 3.33337 9.66665C3.33337 13.1644 6.1689 16 9.66671 16Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
...
const init = () => {
    ...
    router
        .on({
            '/YTVideo/': indexRoute,
            '/YTVideo/video/:id': videoRoute,
            '/YTVideo/favorite': favoriteRoute,
            '/YTVideo/search': searchRoute,
        }).resolve()
    console.log('Phoenix2816/YTVideo: ');
